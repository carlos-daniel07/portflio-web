  ...
  return (
    <div className="relative w-full flex-1 flex flex-col items-center justify-center mt-16 md:mt-0 min-h-screen ">
      ...
      <div className="absolute bottom-32 md:bottom-32 w-full max-w-7xl px-8 flex flex-col md:flex-row justify-between items-center z-20 gap-6 md:gap-8">
        ...
        <div>
          <button className="relative group overflow-hidden rounded-full p-[2px] rotate-12 hover:rotate-1 hover:scale-110 hover:shadow-[0_0_30px_rgba(30,12,199,0.6)] transition-all duration-300">
            <span className="absolute inset-0 bg-gradient-to-r from-blue-900 via-blue-300 to-blue-600 rounded-full"></span>
            <div className="relative bg-[#0a0a0a] text-white px-8 py-3 rounded-full font-bold text-sm uppercase tracking-widest transition-all group-hover:bg-opacity-0 duration-300 group-hover:tracking-[0.3em]">
              Contáctame
            </div>
          </button>
        </div>
